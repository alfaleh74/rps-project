...
function Progress({
  ...
  return (
    <div className={cn("relative w-full", className)}>
      ...
      <div
        className="absolute inset-0 border-y-4 -my-1 border-gray-600 pointer-events-none"
        aria-hidden="true"
      />

      <div
        className="absolute inset-0 border-x-4 -mx-1 border-gray-600 pointer-events-none"
        aria-hidden="true"
      />
    </div>
  );
